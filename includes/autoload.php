...
if (!function_exists('fluentReservationAutoload')) {
    /**
     * Plugin autoloader.
     *
     ...
     * @param $class
     */
    function fluentReservationAutoload($class)
    {
        // Do not load unless in plugin domain.
        $namespace = 'fluentReservation';
    ...
    spl_autoload_register('fluentReservationAutoload');
}
