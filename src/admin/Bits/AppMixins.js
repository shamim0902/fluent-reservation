...
export default class AppMixins {
    constructor() {
        ...
        this.appVars = window.fluentReservationVars;
    ...
    $post(url, options = {}) {
        return window.jQuery.post(window.fluentReservationVars.ajaxurl, options);
    }

    $del(url, options = {}) {
        return window.jQuery.delete(window.fluentReservationVars.ajaxurl, options);
    }

    $put(url, options = {}) {
        return window.jQuery.put(window.fluentReservationVars.ajaxurl, options);
    }

    $patch(url, options = {}) {
        return window.jQuery.patch(window.fluentReservationVars.ajaxurl, options);
    }
